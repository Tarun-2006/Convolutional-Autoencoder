...
def visualize_denoising(model, loader, num_images=10):
    ...
    print("Name: Tarun S")
    print("Register Number: 212223040226")
...
![image](https://github.com/user-attachments/assets/89afccec-d349-4ca5-a93a-c014738422d1)



### Original vs Noisy Vs Reconstructed Image

![image](https://github.com/user-attachments/assets/dd2b62b0-e882-422e-b56c-ba37a0b40f5b)
